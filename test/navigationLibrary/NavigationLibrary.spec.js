...
ava('.generateDynamicPositionModelForLatLong() returns a DynamicPositionModel from a set of latitude and longitude coordinates', (t) => {
    const latLongMock = [113.4636606631233, 6.12969620221002];
    const navigationLibrary = new NavigationLibrary(AIRPORT_JSON_KLAS_MOCK);
    const result = navigationLibrary.generateDynamicPositionModelForLatLong(latLongMock, airportPositionFixtureKLAS, airportPositionFixtureKLAS.magnetic_north);
