...
ava('.setModeSelectorModeAndFieldValue() sets modeSelector and a fieldValue', (t) => {
    const speedMock = 230;
    const controller = new ModeController();

    controller.setModeSelectorModeAndFieldValue(MCP_MODE_NAME.SPEED, MCP_MODE.SPEED.VNAV, speedMock);
