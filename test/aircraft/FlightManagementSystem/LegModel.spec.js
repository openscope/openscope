...
//     const model = new LegModel(directRouteStringMock, runwayMock, arrivalFlightPhaseMock, navigationLibraryFixture);
...
//     const model = new LegModel(directRouteStringMock, runwayMock, arrivalFlightPhaseMock, navigationLibraryFixture);
//     const result = model._buildWaypointForDirectRoute(directRouteStringMock);
//
...
// });
//
// ava('._buildProcedureType() returns early when #routeString is a directRouteString', (t) => {
//     const model = new LegModel(directRouteStringMock, runwayMock, arrivalFlightPhaseMock, navigationLibraryFixture);
//
