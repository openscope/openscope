...
export default class AircraftModel {
    ...
    constructor(options = {}) {
        ...
        /**
         * This value is generated by the `AircraftController` and is
         * unique to every aircraft
         *
         * Currently only numeric, but could be made alpha-numberic
         *
         * Padded with leading zeros in `#cid` for display purposes
         *
         * @property cidValue
         * @type {number}
         * @default 0
        ...
        /**
         * A string version of `#cidValue` for display purposes
    ...
    parse(data) {
        ...
        this.cidValue = data.cid;
        this.cid = leftPad(this.cidValue, 3);
