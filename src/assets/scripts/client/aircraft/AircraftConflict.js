...
export default class AircraftConflict {
    constructor(first, second) {
        ...
        this.distance = vlen(vsub(first.position.relativePosition, second.position.relativePosition));
    ...
    _recalculateLateralAndVerticalDistances() {
        ...
        this.distance = vlen(vsub(this.aircraft[0].position.relativePosition, this.aircraft[1].position.relativePosition));
        ...
        if (conflict) {
            ...
            if (hdg_difference >= degreesToRadians(15)) {
                if (hdg_difference > degreesToRadians(165)) {
                    ...
                    const dx = a2.position.relativePosition[0] - a1.position.relativePosition[0];
                    const dy = a2.position.relativePosition[1] - a1.position.relativePosition[1];
